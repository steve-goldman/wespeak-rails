...
class GroupEmailDomainsControllerTest < ActionController::TestCase
  ...
  test "create with missing domain should redirect" do
    [nil, "", "   "].each do |missing_domain|
      ...
      assert_rendered_with_flash [ValidationMessages::DOMAIN_NOT_PRESENT], 'my_groups/edit'
    end
  end
  ...
  test "create with taken domain should redirect" do
    ...
    post_create @group.id, new_domain
    assert_rendered_with_flash [ValidationMessages::DOMAIN_TAKEN], 'my_groups/edit'
  ...
  test "create with too long domain should redirect" do
    ...
    assert_rendered_with_flash [ValidationMessages::DOMAIN_TOO_LONG], 'my_groups/edit'
  ...
  test "create with bad domain format should redirect" do
    ["stanford", "dot com", ".ABC.o", "a-D123."].each do |invalid_domain|
      ...
      assert_rendered_with_flash [ValidationMessages::DOMAIN_FORMATTING], 'my_groups/edit'
    end
  end
  ...
  test "destroy for unknown domain should redirect" do
    ...
    assert_redirected_with_flash [FlashMessages::DOMAIN_UNKNOWN], my_groups_path
  end
  ...
  def post_create(group_id, domain)
    post :create, my_group_id: group_id, group_email_domain: { domain: domain }
  end

  def delete_destroy(group_id, domain_id)
    post :destroy, my_group_id: group_id, id: domain_id
  end
